...
@implementation MZMenuListTableViewCell
...
- (void)setupView{
    ...
    if (self.data.sections.count>0){
        MZMenuSection* section = [self.data.sections firstObject];
        self.lblDetail.text = section.listItemString;
    }else{
        self.lblDetail.text = @"";
    }
